# 🎨 Shadcn/UI Carousel for Weweb

Beautiful **Carousel component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-carousel`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The Carousel component will appear in your elements!
